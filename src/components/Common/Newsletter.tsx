              ...
              <form>
                <div className="flex flex-col sm:flex-row gap-4">
                  <input
                    ...
                    className="w-full bg-gray-1 border border-gray-3 outline-none rounded-md placeholder:text-dark py-3 px-5"
                  />
                  <button
                    type="submit"
                    className="inline-flex justify-center py-3 px-7 text-dark bg-blue font-medium rounded-md ease-out duration-200 hover:bg-blue-dark"
                  >
                    Subscribe
                  </button>
                </div>
