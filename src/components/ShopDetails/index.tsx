              ...
              <div className="flex flex-col lg:flex-row gap-7.5 xl:gap-17.5">
                ...
                <div className="max-w-[539px] w-full">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="inline-flex font-medium text-custom-sm text-dark bg-blue rounded py-0.5 px-2.5">
                      30% OFF
                    </div>
                  </div>
                  ...
                  <form onSubmit={(e) => e.preventDefault()}>
                    ...
                    <div className="flex flex-wrap items-center gap-4.5">
                      ...
                      <a
                        href="#"
                        className="inline-flex font-medium text-dark bg-blue py-3 px-7 rounded-md ease-out duration-200 hover:bg-blue-dark"
                      >
                        Purchase Now
                      </a>
